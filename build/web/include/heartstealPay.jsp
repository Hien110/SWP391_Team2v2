...
<html lang="en">
    ...
    <body>
            ...
            <div class="modal fade" id="linkpaypalModal" tabindex="-1" aria-labelledby="passwordModalLabel" aria-hidden="true" style="background-color: #0000; margin-top: 200px">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="password" class="form-label">Email Paypal</label>
                                <input type="email" class="form-control" id="password" name="emailPaypal" required>
                            </div>
                            <div class="mb-3">
        ...
        <!--payment-->
        <form id="linkpaypalModal" method="post" action="./heartstealpay">
            ...
            <div class="modal fade" id="paymentModal" tabindex="-1" aria-labelledby="passwordModalLabel" aria-hidden="true" style="background-color: #0000; margin-top: 200px">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="password" class="form-label">Số tiền</label>
                                <input type="text" class="form-control" id="password" name="money"  placeholder="Đơn vị: $ (Đô la)" required>
