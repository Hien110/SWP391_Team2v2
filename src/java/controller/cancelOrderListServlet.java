...
import repository.listTypeProductRepository;

/**
 *
 * @author HP
 */
@WebServlet(name = "CancelOrderListServlet", urlPatterns = {"/CancelOrderList"})
public class cancelOrderListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<typeOrderShop> list = sl.getCancelOrderListShopOwner(2);
