...
<%
    ...
    double surplus = (double) request.getAttribute("surplus");
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <div class="bg-light p-4 rounded">
            ...
            <div class="payment-section mb-3">
                ...
                <div id="surplus-section" class="payment-form" style="border: 1px solid #ccc; padding: 10px; display: none;">
                    <p>Ví của bạn: ₫<span id="surplusAmount">${surplus}</span></p>
                    <p style="color: #000"><fmt:formatNumber value="${surplus * 24000}" pattern="#,###"/> VNĐ</p>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('orderForm').addEventListener('submit', function (event) {
            ...
            var totalAmount = parseFloat(document.getElementById('calculatedTotalInput').value);
            var userSurplus = parseFloat(document.getElementById('surplusAmount').innerText);
            if (paymentMethod === 'heasteal' && userSurplus < totalAmount / 24000) {
